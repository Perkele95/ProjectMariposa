...
static const char* gVertexShaderPath = {"../source/Shaders/vert.spv"};
static const char* gFragmentShaderPath = {"../source/Shaders/frag.spv"};
// --------------------
// --------------------
...
typedef struct TexCubeVsUniform
{
    float mvp[4][4];
...
static const float gVertexData[] =  {
